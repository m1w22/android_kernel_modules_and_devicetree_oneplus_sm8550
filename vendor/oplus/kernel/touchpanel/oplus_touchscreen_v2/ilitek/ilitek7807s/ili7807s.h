...
extern int ili_mp_test_main(char *apk, struct seq_file *s,
			    char *message, int msg_size,
			    bool lcm_on, void *chip_data,
			    struct auto_testdata *testdata);

extern int ili_mp_test_handler(char *apk, struct seq_file *s,
			       char *message, int msg_size,
			       bool lcm_on, void *chip_data,
			       struct auto_testdata *testdata);
...
extern void ili_dump_data(void *data, int type, int len, int row_len,
			  const char *name);
