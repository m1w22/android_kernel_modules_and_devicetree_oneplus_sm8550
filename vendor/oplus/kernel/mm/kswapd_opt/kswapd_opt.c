...
#if IS_ENABLED(CONFIG_OPLUS_FEATURE_KSWAPD_OPT)
...
#if IS_ENABLED(CONFIG_ALLOC_ADJUST_FLAGS)
DEFINE_STATIC_KEY_FALSE(alloc_adjust_enable);
static bool g_alloc_adjust_enabled = false;
...
#if IS_ENABLED(CONFIG_ALLOC_ORDER_STAT)
